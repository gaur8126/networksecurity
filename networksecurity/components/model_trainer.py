...
import mlflow
import dagshub
dagshub.init(repo_owner='gaur8126', repo_name='networksecurity', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,X_test,y_test):
        models = {
            ...
            "LogisticsRegression":LogisticRegression(verbose=1),
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            logging.info(f"y_train {np.unique(y_train)}")
            logging.info(f"y_train {np.unique(y_test)}")
